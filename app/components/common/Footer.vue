...
<template>
  <footer class="bg-muted text-foreground">
    <div class="container mx-auto px-4 py-12">
      <div
        class="grid gap-8 md:grid-cols-4 justify-items-center md:justify-items-start text-center md:text-left max-w-5xl mx-auto"
      >
        <div class="md:col-span-1">
          <div class="flex items-center justify-center md:justify-start mb-4">
            ...
            >
              <Icon.GraduationCap class="w-6 h-6 text-primary-foreground" />
            </div>
            <div>
        ...
        <div>
          <h4 class="text-lg font-bold text-foreground mb-4">
      ...
      <div
        class="border-t border-border mt-12 pt-8 text-center max-w-5xl mx-auto"
      >
